/*
	Banco de dados do projeto Revise
    Diretorio Pai - databases
    
	@version 1.3
*/

-- Criação do banco de dados
create database dbRevise;

-- drop database dbRevise;
...
INSERT INTO tb_uf (cd_uf,nm_uf,sg_uf) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
create table tb_tipo( -- TABELA TIPO
...
create table tb_categoria( -- TABELA CATEGORIA
...
nm_versao varchar(45),
constraint pk_versao
	primary key (cd_versao));    

INSERT INTO tb_versao (cd_versao, nm_versao) VALUES
(1,'LT 1.0'),
(2,'LT 1.4'),
(3,'ADVANTAGE'),
(4,'LTZ 1.4'),
...
create table tb_marca( -- TABELA MARCA
cd_marca int not null,
nm_marca varchar(45),
constraint pk_marca
	primary key (cd_marca));

INSERT INTO tb_marca(cd_marca, nm_marca) VALUES
(1,'GM');

create table tb_troca( -- TABELA TROCA
cd_troca int not null,
nm_troca varchar(45),
ds_troca TEXT(500),
dt_troca date,
constraint pk_troca
	primary key (cd_troca));
    
create table tb_plano( -- TABELA PLANO
...
INSERT INTO tb_plano (cd_plano, nm_plano, ds_plano, vl_plano, dt_vencimento) VALUES
(1,'Gratuido','Plano gratuito com limite de veiculo de 3 unidades cadastraveis.',00.00,null),
(2,'Plano luxo','Plano luxo, sendo limite cadastravel ilimitado de veiculos vinculado a conta.',20.00,null),
(3,'Anúncio unitario','Possibilitando anuncio de serviço ou produto por unidade.',5.00,null),
(4,'Pacote anúncios','Pacote de anúncios contendo quantidade de 10 anúncios.',40.00,null),
(6,'Pacote personalizado','Pacote personalizado, o fornecedor de produto e serviço pode escalar quantidade de anúncios vai querer, variando o preço pela quantidade utilizado.',null,null);
   
create table tb_manual(
cd_manual int not null,
nm_manual varchar(45),
constraint pk_manual
	primary key (cd_manual));

create table tb_cadastro(
cd_cadastro int not null,
nm_cadastro varchar(45),
dt_cadastro text(500),
...
nm_anuncio varchar(20) not null,
ds_anuncio text(500),
vl_anuncio decimal not null, 
cd_plano int not null,
constraint pf_anuncio
...
ds_componente text(500),
cd_troca int not null,
constraint pk_componente
	primary key (cd_componente),
constraint fk_troca
	foreign key (cd_troca)
		references tb_troca(cd_troca));
  
create table componente_manual(
cd_manual int not null,
cd_componente int not null,
constraint fk_manual
	foreign key (cd_manual)
		references tb_manual(cd_manual),
constraint fk_componente
	foreign key (cd_componente)
		references tb_componente(cd_componente));
...
cd_placa varchar(9) not null,
aa_veiculo int,
sg_estado_veiculo varchar(4),
nm_cor_veiculo varchar(45),
qt_km_veiculo double not null,
cd_usuario int not null,
cd_manual int not null,
cd_marca int not null,
...
constraint fk_marca_modelo
	foreign key (cd_marca)
		references tb_marca(cd_marca),
constraint fk_tipo_modelo
	foreign key (cd_tipo)
		references tb_tipo(cd_tipo),
constraint fk_categoria_modelo
	foreign key (cd_categoria)
		references tb_categoria(cd_categoria),
constraint fk_versao_modelo
	foreign key (cd_versao)
		references tb_versao(cd_versao));

INSERT INTO tb_modelo (cd_modelo,nm_modelo,cd_marca,cd_tipo,cd_categoria,cd_versao) VALUES
(1,'ONIX JOY',1,1,NULL,6),
(2,'ONIX',1,NULL,NULL,1),
(3,'ONIX',1,NULL,NULL,2),
(4,'ONIX',1,NULL,NULL,3),
(5,'ONIX',1,NULL,NULL,4),
(6,'ONIX',1,NULL,NULL,5),
(7,'PRISMA JOY',1,NULL,NULL,7),
(8,'PRISMA',1,NULL,NULL,2),
(9,'PRISMA',1,NULL,NULL,3),
(10,'PRISMA',1,NULL,NULL,4),
(11,'ONIX ACTIV',1,NULL,NULL,8),
(12,'COBALT',1,NULL,NULL,9),
(13,'SPIN',1,NULL,NULL,10),
(14,'SPIN',1,NULL,NULL,11),
(15,'SPIN',1,NULL,NULL,12),
(16,'SPIN',1,NULL,NULL,13),
(17,'SPIN ACTIV',1,NULL,NULL,13);
