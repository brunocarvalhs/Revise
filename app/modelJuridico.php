...
class modelJuridico extends modelUsuario
{
    ...
    public function dadosUsuario($IdJuridico){
        ...
        ->select('tb_usuario_juridico.nm_nome_fantasia as Fantasia','tb_usuario_juridico.nm_razao_social as Razao','tb_usuario.nm_email as Email','tb_usuario_juridico.cd_cnpj as CNPJ','tb_logradouro.nm_logradouro as Endereco','tb_bairro.nm_bairro as Bairro','tb_cidade.nm_cidade as Cidade')
        ->first();
