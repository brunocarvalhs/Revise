<div class="modal fade" id="modalTermoDeUso" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header text-center">
                <h4 class="modal-title w-100 font-weight-bold">Termos de Uso</h4>
            </div>
        </div>
        <div class="modal-content">
                ...
                <div class="row p-2">
                    <div class="col-12">
                        ...
                        <p>
                            ...
                            usuário deverá
                            cientificar-se de eventuais modificações ou atualizações ocorridas neste termo.
                        </p>
                        <p>
                        ...
                        <p>
                            Caso não concorde com quaisquer das regras aqui descritas, o usuário deve, imediatamente,
                            abster-se de utilizar
                            o serviço. Se for de seu interesse, poderá, ainda, entrar em contato com o serviço de
                        ...
                        <ol>
                            <li>
                                Suspender, interromper ou limitar o acesso a todo ou a parte do site a uma categoria
                                específica de
                                internautas;
                            </li>
                            <li>
                                Remover toda informação que possa perturbar o funcionamento do site ou que estejam em
                                conflito com normas de
                        ...
                        <p>
                            ...
                            capazes, conforme o
                            Direito
                            Brasileiro. Todos aqueles que não possuírem plena capacidade civil – menores de 18 anos não
                            emancipados,
                            pródigos,
                            ébrios habituais ou viciados em tóxicos e pessoas que não puderem exprimir sua vontade, por
                            motivo transitório
                            ou
                            preeminente- deverão ser devidamente assistidos por seus representantes legais, que se
                            responsabilizarão pelo
                            cumprimento das presentes regras.
                        </p>
                        <p>
                            Ao usuário, será permitido manter apenas uma conta junto ao site. Contas duplicadas serão
                            automaticamente
                        ...
                        <p>
                            Após a confirmação do seu cadastro, o usuário terá um login e uma senha pessoais, que não
                            deverão ser passados
                            para
                            terceiros sendo de sua inteira responsabilidade o uso que deles seja feito. O usuário
                            compromete-se a comunicar
                            imediatamente ao editor do site quaisquer atividades suspeitas ou inesperadas em sua conta.
                        </p>
                        <p>
                        ...
                        <ol>
                            <li>
                                Pela correta utilização do site e de seus serviços, prezando pela boa convivência, pelo
                                respeito e pela
                            ...
                            <li>
                                Pela proteção dos dados de acesso à sua conta (login e senha).
                            </li>
                        </ol>
                        <p>
                        ...
                        <p>
                            ...
                            desta previsão
                            apenas
                            ou elementos que estejam expressamente designados no site como livres de direitos autorais.
                            O acesso não gera para o usuário qualquer direito de propriedade intelectual relativo a
                            elementos do site, os
                            quais
                        ...
                        <ul>
                            <li>
                                Seus dados pessoais serão processados de forma lícita, leal e transparente (licitude,
                                lealdade e transparência);
                            </li>
                            <li>
                                Seus dados pessoais serão coletados apenas para finalidades determinadas, explícitas e
                                legítimas, não podendo ser
                        ...
                        <p>
                            ...
                            seu serviço de atendimento, através do endereço de e-mail: revise@gmail.com. Este serviço de
                            atendimento estará
