...
<section>
    ...
    <div class="backgroundBlackLight">
        ...
        <form id="CadastroJuridico" action="{{ url('/CadastroJuridico') }}" method="POST"
            onsubmit="return ValidarCadastroJuridico();" name="CadastroJuridico">
            @csrf
            <div class="row">
                <div class="col-12">
...
que consta em documentos legais e é usado em termos formais" name="razaoSocial">
                            ...
                            <div class="col-12 col-sm-12 col-md col-lg col-xl">
                                <input type="text" class="form-control" id="nomeFantasia" placeholder="Nome Fantasia"
                                    data-toggle="tooltip" data-placement="top" title="É o nome popular de uma empresa, ou seja, como é conhecida.
    Pode ou não ser igual à sua razão social" name="nomeFantasia">
                            ...
                            <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="txtCEP" maxlength="8" name="txtCEP"
                                                    class="form-control" data-mask="00000-000" placeholder="XXXXX-XXX">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="form-row inputCadastro">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
                                        <div class="form-group inputCadastro">
                                            <input type="text" class="form-control somente-numero" id="txtNumero"
                                                name="txtNumero" placeholder="Número" data-mask="000000">
                                        </div>
                                    </div>
                                    <!--FIM-->
                                </div>
                        ...
                        <div class="form-group inputCadastro">
                            ...
                            <input type="email" class="form-control" id="campoEmail" name="campoEmail"
                        ...
                        <div class="form-group inputCadastro">
                            <div class="form-row">
                                ...
                                <div class="col-12 col-sm-12 col-md col-lg col-xl">
                                    ...
                                    <input type="text" class="form-control" data-mask="00.000.000/0000-00"
                                        name="txtcnpj" id="txtcnpj" placeholder="XX.XXX.XXX/YYYY-ZZ">
                                </div>
                    ...
                    <div class="form-group inputCadastro">
                        ...
                        <input type="password" id="campoSenha" class="form-control" name="campoSenha"
                    ...
                    <div class="form-group inputCadastro">
                        ...
                        <input type="password" id="campoConfirmaSenha" name="campoConfirmaSenha" class="form-control"
                            aria-describedby="descricaoSenha">
                    </div>
                    <!-- Termos de uso -->
            <div class="row mt-5">
                <div class="col-12">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="termos" id="inlineCheckbox1" value="option1">
