<?php
    /**
     * Pagina de veículos, acesso aos dados do veículo 
     * 
     * 
     * Diretorio Pai - View
     * 
        ...
        <div class="row">
                ...
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        <?php 
                            echo "ABC-1234 - Onix"
                        ?>
                        <button type="button" class="btn btn-primary btn-lg btn-block">Adicionar Veículo</button>
                    </div>
                </div>
            </div>
            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-8 col-xl-8">
                ...
                <div class="box-actions">
                    ...
                    <button class="btn btn-danger">Apagar Veículo</button>
                </div>
