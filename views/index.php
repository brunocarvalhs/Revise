            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" id="selecionado" href="index.php">Home</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="_file/_img/Revisão-do-carro.jpg" class="d-block w-100 h-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="_file/_img/revisao-carro.jpg" class="d-block w-100 h-100" alt="...">
                            </div>
                        </div>
                    ...
                    <div class="conteudo-Preto">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col">
                                    <br><br><br>
                                    <p class="text-white display-4" align="center"> Praticidade e segurança que você
                                        exige?</p>
                                    <h1 class="text-warning display-4" align="center">REVISE</h1>
                                </div>
                            </div>
                        </div>
                    </div>
