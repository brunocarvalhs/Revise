    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-0 col-sm-0 col-md-2 col-lg-2 col-xl-2">
                <div class="container-fluid">
                    <div class="row">
                        <div class="page-wrapper chiller-theme toggled navbar-brand ">
            ...
            <div class="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-10" style="background-color: palegreen; padding: 50px;">
