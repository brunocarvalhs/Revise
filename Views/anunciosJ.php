...
<body id="sistemaJ" class="bg-light">
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-8">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-10 paddingCards">
                    <div class="card bg-white h-100">

                        <div class="card-body ">
                            <img width="300px" height="300px" align="left"
                                src="https://http2.mlstatic.com/oleo-do-motor-ipiranga-f1-master-sintetico-10w40-sm-4l-D_NQ_NP_656972-MLB31088368276_062019-O.webp"
                                alt="...">
                            <br><br>
                            <h4 class="card-text text-dark" align="center">Óleo Do Motor Ipiranga 4L </h4>
                            <p class="card-text text-dark" align="center"> Ipiranga F1 Master Sintético 10W40 SM - 4
                                Litros
                                Óleo lubrificante 100% sintético. Sua formulação atua diretamente no controle
                                da oxidação e do espessamento do óleo, com maior proteção contra o desgaste visando a
                                durabilidade do motor. </p>
                            <h5 class="card-text text-dark" align="center"> Preço : R$162,00 </p>
                ...
                <div>
                    <br><br><br><br>
                    <h5 class="card-text text-dark">Caracteristicas do Produto:</h5>
                    <div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-10 paddingCards">
                    <div class="card bg-white h-100">
                        ...
                        <div class="card-body ">
                            <br><br>
                            <h5 class="card-text text-dark" align="left">Marca: Ipiranga </h5>
                            <p class="card-text text-dark" align="center"> Ipiranga F1 Master Sintético 10W40 SM - 4
                                Litros
                                Óleo lubrificante 100% sintético. Sua formulação atua diretamente no controle
                                da oxidação e do espessamento do óleo, com maior proteção contra o desgaste visando a
